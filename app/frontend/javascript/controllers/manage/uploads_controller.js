...
export default class extends Controller {
  static targets = [
    "searchForm", "searchInput", "statusSelect", "fileTypeSelect", "perPageSelect"
  ]

  connect() {
    console.log("Manage uploads controller connected")
  }
  ...
  resetAllFilters() {
    ...
    if (this.hasFileTypeSelectTarget) {
      this.fileTypeSelectTarget.value = ''
    }
