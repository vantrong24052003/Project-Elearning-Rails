...
module Manage
  class InstructorRequestsController < Manage::BaseController
    def index
    ...
    def approve
      ...
      if @user.pending_instructor_request?
        ...
        redirect_to dashboard_admin_instructor_requests_path,
                    notice: "#{@user.name || @user.email} has been approved as an instructor."
      else
